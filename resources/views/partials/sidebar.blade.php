    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="index.html">
            <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
                <img class="dark:hidden" src="{{ asset('images/logo/logo.svg') }}" />
        ...
        <nav x-data="{ selected: $persist('Dashboard') }">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Restaurant' ? '':'Restaurant')"
                            class="menu-item group"
                            :class="(selected === 'Restaurant') || (page === 'formElements' || page === 'formLayout' ||
                                page === 'proFormElements' || page === 'proFormLayout') ? 'menu-item-active' :
                            'menu-item-inactive'">
                            <svg :class="(selected === 'Restaurant') || (page === 'formElements' || page === 'formLayout' ||
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'Restaurant') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive',
                                    sidebarToggle ? 'lg:hidden' : ''
                                ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- Dropdown Menu Start -->
                        <div class="overflow-hidden transform translate"
                            :class="(selected === 'Restaurant') ? 'block' : 'hidden'">
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a href="{{ route('restaurants.index') }}" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="{{ route('restaurants.create') }}" class="menu-dropdown-item group"
                                        :class="page === 'formElements' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Add Resturents
                                    </a>
                    ...
                    <!-- Menu Item Rastaurant -->

                    <!-- Menu Item Calendar -->
                    {{-- <li>
                        <a href="calendar.blade.php" @click="selected = (selected === 'Calendar' ? '':'Calendar')"
                            class="menu-item group"
